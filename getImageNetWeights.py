...
def main():
    os.makedirs('imagenet_resnet_models', exist_ok=True)
    batch_size = 128
    epochs = 5
    ...
    for i in tqdm(range(251), desc="Training models"):
        torch.manual_seed(i)
        ...
        torch.save(model.state_dict(), f'imagenet_resnet_models/resnet_weights_{i}.pt')
